# Shared SDK for Google ADK Agents

**Location:** `/sdk` (workspace root)  
**Purpose:** Shared utilities, factories, and registries for all agents in this workspace
...
> **Note:** This SDK is located at the workspace root level and can be used by any agent (book_agent, introduction, basic_agent, etc.). When running scripts, ensure the workspace root is in your PYTHONPATH.
